...
#   tools/verify.sh
#
# Right now that is the shaders, and only the shaders. This repo's other checks
# -- tools/octest and tools/sweep.py -- are still run by hand and have
# not been folded in here yet.
#
