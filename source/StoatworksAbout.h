 ...
 *
 * GENERATED by stoatworks-backend/scripts/sync-about.py on 2026-08-02. Do not
...
{
    inline constexpr auto name = "Old Cathode";
    inline constexpr auto slug = "old-cathode";
    inline constexpr auto hook = "Analogue TV signal path for Resolume";
